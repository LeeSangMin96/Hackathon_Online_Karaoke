...
def read_in():
    ...
    search_input = sys.stdin.readlines()
    search_query = search_input# + " karaoke"
    search_query = search_query[0]
    search_query = search_query[2:-2]
#    search_query = search_query.decode('cp949').encode('utf-8')
#    print('hi', search_query)
#    print(type("1"))
#    print('hi', str(search_query[0]).decode('cp949'))
#    print('hel', search_query[0].decode('cp949').encode('utf-8'))
    headers = {
    ...
    video_headers = {
        ...
        'accept-language': 'ko,en-US,en;q=0.9',
    ...
    for vid in videoId:
        ...
        for f in streaming_data:
            ...
            if 'url' in keys:
                # print(f['url'])
                karaoke_vid_url = f['url']
                print(karaoke_vid_url)
                # break
                return json.loads(karaoke_vid_url)
